...
class MainWidget(BaseWidget) :
    def __init__(self):
        ...
        hit_line_mid = Line(points=line_pts_mid, width=40)
    ...
    def check_hand(self, gem_x):  
        x_threshold = 40  # within x_threshold screen units on either side of gem_x
        y_threshold = 40  # within y_threshold screen units on top or bottom of line_y
